...
namespace Practical_1
{
    internal class Program
    {
        ...
        {
            Student student = new Student(); student.AcceptDetails(); student.CheckScholarship(); student.DisplayDetails(); Console.WriteLine("\nPress any key to exit..."); Console.ReadKey();
        }
    }
    class Student
    {
        ...
        public Student() { Console.WriteLine("=== Welcome to Student Portal ===\n"); }
